        ...
        <div class="col-12 mb-3">
            <div class="row">
                ...
                <div class="col-12 col-md-6 text-end">
                    <a href="{{ route('admin.occupations.index') }}" class="btn btn-dark rounded btn-sm">
                    ...
                    <form id="uploadExcelForm" enctype="multipart/form-data">
                        ...
                        <div class="col-12 mb-3">
                            <label for="formFile" class="form-label">
                                Selecciona el archivo de "Disponibilidad y ocupaciones actual
                            </label>
        ...
        <div class="col-12 col-lg-12  col-xxl-6">
            <div class="card shadow-sm">
                <div class="card-body d-flex align-items-center justify-content-center px-4" style="height: 7em;">
                    ...
                    <div class="col">
                        <div class="col-12 text-end">
                            <h3><b id="occupations_total">0</b></h3>
                        </div>
                        <div class="col-12 text-end">
                            <small class="text-muted"><strong>Ocupaciones cargadas</strong></small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 col-lg-12  col-xxl-6">
            <div class="card shadow-sm">
                <div class="card-body d-flex align-items-center justify-content-center px-4" style="height: 7em;">
                    ...
                    <div class="col">
                        <div class="col-12 text-end">
                            <h3><b id="out_of_service_total">0</b></h3>
                        </div>
                        <div class="col-12 text-end">
                            <small class="text-muted"><strong>Razones fuera de servicio</strong></small>
                        </div>
                    </div>
                </div>
            </div>
