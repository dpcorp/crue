        ...
        <div class="col-12 mb-3">
            <div class="row">
                <div class="col-12 col-md-6 text-start">
                    <h4 class="fw-bold">Editar rol</h4>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" placeholder="Nombre" name="name"
                                        value="{{ old('name', $rol->name) }}" {{ $rol->editable == 0 ? 'readonly' : '' }}>
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="{{ str_replace(' ', '', $key) }}">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    <span class="badge rounded-pill bg-dark mx-0">
                                                        {{ count($group) }}
                                                    </span>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="form-check">
                                                                                <input
                                                                                    ...
                                                                                    <?php echo $key == 'permissions' ? 'disabled' : ''; ?> <?php echo in_array($permission->id, $permissions_rol) ? 'checked' : ''; ?>>
                                                                                <label class="form-check-label"
                                                                                    for="{{ $permission->name }}">
                            ...
                            @can('admin.roles.edit')
                                <div class="col-12 text-end">
                                    <button class="btn btn-dark btn-rounded btn-sm">Actualizar rol</button>
                                </div>
                            @endcan
                        </div>
                    </form>
