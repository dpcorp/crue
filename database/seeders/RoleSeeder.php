...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(["name" => "admin.blockeds.index", "description" => "Ver", "module" => "Bloqueos"])->syncRoles([$role_one, $role_two]);

        Permission::create(["name" => "admin.out_of_services.index", "description" => "Ver", "module" => "Fuera de servicio"])->syncRoles([$role_one, $role_two]);

        Permission::create(["name" => "admin.saturations.index", "description" => "Ver", "module" => "Saturaciones"])->syncRoles([$role_one, $role_two]);
    }
}
